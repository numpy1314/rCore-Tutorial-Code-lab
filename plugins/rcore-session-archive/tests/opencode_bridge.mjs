...
const { default: definition } = await import(pathToFileURL(join(root, ".opencode/plugins/rcore-session-archive.js")));
assert.equal(definition.id, "rcore-session-archive");
